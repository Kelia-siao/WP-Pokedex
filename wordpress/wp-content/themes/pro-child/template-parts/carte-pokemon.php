...
<div class="pokedex-seul">
    ...
    <svg class="icone-moins" width="59" height="59" viewBox="0 0 59 59" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="29.5" cy="29.5" r="29.5" fill="#A82424"/>
        <path d="M22.7682 26.83H36.2432V31.926H22.7682V26.83Z" fill="white"/>
    </svg>
    ...
    <div class="type">
        <?php
            ...
            foreach($types as $type):
                echo '<a href="' . get_term_link($type) . '"> <div class="pokemon-type type-' . $type->slug . '">';
