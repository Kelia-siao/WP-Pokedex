...
<style><?php include "style/page-gere-3.css"?></style>
...
<div>
    <div class="all-joueur">
        ...
        <a href="http://localhost:8888/wordpress/gerer-equipe/">
        <div class="nom-equipe-1 f-f-1 f-size-28">
            <span class="joueur-seul red">
                Pokepoka
            </span></a>
        </div>
        ...
        <div class="nom-equipe white f-f-1 f-size-28">
            <span class="joueur-seul">
                Team rocket
            </span>
        </div>
